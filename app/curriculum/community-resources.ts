...
export type CommunityArtifact = {
  ...
  preview?: {
    kind: "ipynb" | "databricks-source" | "markdown";
    rawUrl: string;
    path: string;
    upstreamRef: string;
  };
...
const DATABRICKS_EXAMPLES_REF = "dcf7abe288d078fbc8037ecdbd8ced9452bddeb0";
const FINOPS_REF = "7834d5dfd9f7733b24559b4ff30b424f5cdb7008";
const LIGHTHOUSE_REF = "35217ff9e7c1a956ce65793c1f569a15990fe89a";
const UNITY_OSS_REF = "3c831260ecf308137943335fade3eaf278f735f2";
const CRDB_REF = "042cb96da47f8872a097494fa2603a50c3c00eab";
const FREE_PIPELINES_REF = "a51537091b73d27bceaa1e48ae29fe4c78db9441";
const AZURE_HANDS_ON_REF = "a91650ba59d8532736124b125413ccc3f201074a";
const SQL_START_STOP_REF = "0255c1ab6314d6dc076244e0748a4e12229e97f4";
const JUMP_START_REF = "125a9014beab4b1d842aabe5e76b9e6a8cc92e01";
const DLT_NOTEBOOKS_REF = "1d8b163cfc4c45aad40c3c552807a2a0c2890cf6";
const BUNDLES_REF = "c1db7922077e86cbee4bc5f208e2bfc65974dbc9";
const LAKEFLOW_DEMO_REF = "5925f2ed4407af0cfe8803c2987f0a8e59bfd5f7";
const SALES_PIPELINE_REF = "cf92e3dd32304e9c9879cd327f0d9ae66428c1ca";
const BUNDLES_TUTORIAL_REF = "9fe52bcd58c23d55b126c24f75af18d38b49db98";
const PURVIEW_REF = "f8231274d929216478ec900789f2efc78442bf2f";

export const communityRepositories: CommunityRepository[] = [
  { id: "learn", name: "Learn Databricks", url: "https://github.com/jaceklaskowski/learn-databricks", author: "Jacek Laskowski", provenance: "community", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: LEARN_REF, reviewedAt: REVIEWED_AT },
  { id: "startup", name: "Startup ERP Data Lakehouse", url: "https://github.com/Caliu-Data/databricks-startups-metrics", author: "Caliu-Data", provenance: "community", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: STARTUP_REF, reviewedAt: REVIEWED_AT },
  ...
  { id: "best-practices", name: "notebook-best-practices", url: "https://github.com/databricks/notebook-best-practices", author: "Databricks", provenance: "official", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: BEST_PRACTICES_REF, reviewedAt: REVIEWED_AT },
  ...
  { id: "databricks-examples", name: "databricks-examples", url: "https://github.com/data-engineering-helpers/databricks-examples", author: "data-engineering-helpers", provenance: "community", license: "CC0-1.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: DATABRICKS_EXAMPLES_REF, reviewedAt: REVIEWED_AT },
  { id: "delta-examples", name: "Delta Lake examples", url: "https://github.com/delta-io/delta-examples", author: "Delta Lake", provenance: "official", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE.txt", licenseEvidenceRef: DELTA_REF, reviewedAt: REVIEWED_AT },
  ...
  { id: "yokawasa", name: "databricks-notebooks", url: "https://github.com/yokawasa/databricks-notebooks", author: "yokawasa", provenance: "community", license: "MIT", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: YOKAWASA_REF, reviewedAt: REVIEWED_AT },
  { id: "azure-demos", name: "Azure Databricks Integration Demos", url: "https://github.com/mjtpena/azure-databricks-demos", author: "Michael John Peña", provenance: "community", license: "MIT", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: AZURE_DEMOS_REF, reviewedAt: REVIEWED_AT },
  { id: "crdb", name: "crdb_to_dbx", url: "https://github.com/rsleedbx/crdb_to_dbx", author: "rsleedbx", provenance: "community", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: CRDB_REF, reviewedAt: REVIEWED_AT },
  ...
  { id: "finops", name: "databricks-finops-system-tables", url: "https://github.com/drcaiomoreno/databricks-finops-system-tables", author: "Caio Moreno", provenance: "community", license: "MIT", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: FINOPS_REF, reviewedAt: REVIEWED_AT },
  { id: "cost", name: "Databricks shared clusters cost calculator", url: "https://github.com/mwojtyczka/databricks-shared-clusters-cost-calculator", author: "mwojtyczka", provenance: "community", license: "MIT", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: COST_REF, reviewedAt: REVIEWED_AT },
  { id: "lighthouse", name: "lighthouse", url: "https://github.com/Databeans/lighthouse", author: "DataBeans", provenance: "community", license: "MIT", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: LIGHTHOUSE_REF, reviewedAt: REVIEWED_AT },
  ...
  { id: "unity-oss", name: "Unity Catalog OSS", url: "https://github.com/unitycatalog/unitycatalog", author: "Unity Catalog", provenance: "official", license: "Apache-2.0", licenseStatus: "verified", licenseEvidencePath: "LICENSE", licenseEvidenceRef: UNITY_OSS_REF, reviewedAt: REVIEWED_AT },
];
...
export const communityArtifacts: CommunityArtifact[] = [
  ...
  artifact({ id: "free-pipelines", repositoryId: "free-pipelines", title: "Databricks Free Declarative Pipelines", summary: "Curso práctico de arquitectura medallion y pipelines declarativos con datos de comercio electrónico.", format: "project", languages: ["SQL"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "Diseñado para Databricks Free Edition y Lakeflow Designer.", freeEdition: "supported", importMode: "repository", externalSource: { path: "docs/3-2-building-bronze-sql.md", upstreamRef: FREE_PIPELINES_REF } }),
  artifact({ id: "azure-hands-on", repositoryId: "azure-hands-on", title: "Azure Databricks Hands-on", summary: "Ruta lineal de ejercicios PySpark, SQL, streaming y orquestación distribuida como archivo DBC.", format: "dbc", languages: ["Python", "SQL"], clouds: ["Azure"], difficulty: "beginner", runtimeNotes: "Importa HandsOn.dbc en un workspace de Azure Databricks.", freeEdition: "partial", importMode: "dbc", externalSource: { path: "HandsOn.dbc", upstreamRef: AZURE_HANDS_ON_REF } }),
  artifact({ id: "azure-streaming", repositoryId: "azure-hands-on", title: "Structured Streaming with Event Hubs or Kafka", summary: "Ejercicios guiados para conectar Structured Streaming con Event Hubs o Kafka.", format: "dbc", languages: ["Python"], clouds: ["Azure"], difficulty: "intermediate", runtimeNotes: "Necesita el servicio de eventos y credenciales de Azure.", freeEdition: "unsupported", importMode: "dbc", externalSource: { path: "HandsOn.dbc", upstreamRef: AZURE_HANDS_ON_REF } }),
  artifact({ id: "sql-start-stop", repositoryId: "sql-start-stop", title: "databricks-sql-start-stop", summary: "Automatiza arranque, parada y configuración de SQL Warehouses mediante Workflows.", format: "project", languages: ["Python"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "El principal del job necesita permisos sobre el warehouse.", freeEdition: "partial", importMode: "repository", externalSource: { path: "update_sql_warehouse.py", upstreamRef: SQL_START_STOP_REF } }),
  ...
  artifact({ id: "crdb", repositoryId: "crdb", title: "crdb_to_dbx", summary: "Proyecto de ingestión y CDC desde CockroachDB hacia Databricks.", format: "project", languages: ["Python", "SQL"], clouds: ["Multinube"], difficulty: "advanced", runtimeNotes: "Necesita una fuente CockroachDB y conectividad configurada.", freeEdition: "unsupported", importMode: "repository", preview: { kind: "ipynb", rawUrl: raw("rsleedbx/crdb_to_dbx", CRDB_REF, "crdb_to_dbx/cockroachdb-cdc-tutorial.ipynb"), path: "crdb_to_dbx/cockroachdb-cdc-tutorial.ipynb", upstreamRef: CRDB_REF } }),
  artifact({ id: "bundles", repositoryId: "bundles", title: "bundle-examples", summary: "Ejemplos oficiales de Declarative Automation Bundles para Python, SQL, Jobs y Lakeflow.", format: "bundle", languages: ["Python", "SQL", "YAML"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "Requiere Databricks CLI y autenticación del workspace.", freeEdition: "partial", importMode: "bundle", externalSource: { path: "default_python/src/sample_notebook.ipynb", upstreamRef: BUNDLES_REF } }),
  artifact({ id: "lakeflow-demo", repositoryId: "lakeflow-demo", title: "lakeflow_declarative_pipelines_demo", summary: "Proyecto estructurado con SCD2, pruebas y despliegue mediante Bundles.", format: "bundle", languages: ["Python", "SQL", "YAML"], clouds: ["Multinube"], difficulty: "advanced", runtimeNotes: "Pensado para Free Edition con Databricks CLI y Bundles.", freeEdition: "supported", importMode: "bundle", externalSource: { path: "src/python/notebooks/04.scd_genie_code_pipeline.py", upstreamRef: LAKEFLOW_DEMO_REF } }),
  artifact({ id: "sales-pipeline", repositoryId: "sales-pipeline", title: "Sales Data Declarative Pipeline", summary: "Pipeline declarativo de ventas para practicar expectations, transformación y capas medallion.", format: "project", languages: ["Python", "SQL"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "Requiere Lakeflow Declarative Pipelines.", freeEdition: "partial", importMode: "repository", externalSource: { path: "source_code/DLT_Root/transformations/practice_tutorial/1_corecomponents.py", upstreamRef: SALES_PIPELINE_REF } }),
  artifact({ id: "finops", repositoryId: "finops", title: "databricks-finops-system-tables", summary: "Consultas y referencias para gasto, uso, auditoría y observabilidad mediante system tables.", format: "repository", languages: ["SQL"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "Necesita system tables habilitadas; el repositorio actúa como guía de consultas.", freeEdition: "unsupported", importMode: "repository", preview: { kind: "markdown", rawUrl: raw("drcaiomoreno/databricks-finops-system-tables", FINOPS_REF, "README.md"), path: "README.md", upstreamRef: FINOPS_REF } }),
  ...
  artifact({ id: "lighthouse", repositoryId: "lighthouse", title: "lighthouse", summary: "Herramienta para observar salud del layout, clustering, mantenimiento y coste del lakehouse.", format: "project", languages: ["Scala"], clouds: ["Multinube"], difficulty: "advanced", runtimeNotes: "Valida compatibilidad con las tablas y runtime de destino.", freeEdition: "unknown", importMode: "repository", preview: { kind: "databricks-source", rawUrl: raw("Databeans/lighthouse", LIGHTHOUSE_REF, "notebooks/databricks/DeltaClusteringMetrics.scala"), path: "notebooks/databricks/DeltaClusteringMetrics.scala", upstreamRef: LIGHTHOUSE_REF } }),
  artifact({ id: "bundles-tutorial", repositoryId: "bundles-tutorial", title: "Databricks Asset Bundles tutorial", summary: "Tutorial comunitario sobre estructura y ejecución de notebooks Python y SQL dentro de Bundles.", format: "bundle", languages: ["Python", "SQL", "YAML"], clouds: ["Multinube"], difficulty: "intermediate", runtimeNotes: "Requiere Databricks CLI y un workspace configurado.", freeEdition: "partial", importMode: "bundle", externalSource: { path: "part_1_basic_setup/src/notebook.ipynb", upstreamRef: BUNDLES_TUTORIAL_REF } }),
  artifact({ id: "purview", repositoryId: "purview", title: "unity-catalog-purview-integration-samples", summary: "Ejemplos especializados de catalogación, metadatos y lineage entre Unity Catalog y Purview.", format: "project", languages: ["Python"], clouds: ["Azure"], difficulty: "advanced", runtimeNotes: "Necesita Azure Databricks, Unity Catalog y Microsoft Purview.", freeEdition: "unsupported", importMode: "repository", externalSource: { path: "Bi-directional integration between Databricks Unity Catalog and Microsoft Purview.ipynb", upstreamRef: PURVIEW_REF } }),
  artifact({ id: "unity-oss", repositoryId: "unity-oss", title: "Unity Catalog OSS", summary: "Catálogo abierto y multi-engine para explorar interoperabilidad más allá de un notebook Databricks.", format: "project", languages: ["Java", "Python"], clouds: ["Multinube"], difficulty: "advanced", runtimeNotes: "Equivalente conceptual; no es un notebook ni sustituye un laboratorio de OpenSharing.", freeEdition: "unknown", importMode: "repository", preview: { kind: "markdown", rawUrl: raw("unitycatalog/unitycatalog", UNITY_OSS_REF, "docs/quickstart.md"), path: "docs/quickstart.md", upstreamRef: UNITY_OSS_REF } }),
];
...
function validateCommunityRegistry() {
  ...
  for (const repository of communityRepositories) {
    if (repository.licenseStatus !== "verified") continue;
    if (
      !repository.licenseEvidencePath
      || !/^[a-f0-9]{40}$/.test(repository.licenseEvidenceRef ?? "")
      || repository.licenseEvidencePath.split("/").some((part) => !part || part === "." || part === ".." || part.includes("\\") || part.includes("\0"))
    ) {
      throw new Error(`${repository.id} necesita evidencia de licencia fijada a un commit.`);
    }
  }
  ...
  for (const item of communityArtifacts) {
    ...
    if (item.preview && item.externalSource) throw new Error(`${item.id} no puede declarar dos orígenes revisados.`);
    const reviewedSource = item.preview ?? item.externalSource;
    if (!reviewedSource) throw new Error(`${item.id} necesita un archivo concreto fijado a un commit.`);
    if (!/^[a-f0-9]{40}$/.test(reviewedSource.upstreamRef)) throw new Error(`${item.id} necesita un commit fijado.`);
    const reviewedPathParts = reviewedSource.path.split("/");
    if (reviewedPathParts.some((part) => !part || part === "." || part === ".." || part.includes("\\") || part.includes("\0"))) {
      throw new Error(`${item.id} usa una ruta revisada no permitida.`);
    }
    if (item.preview) {
      if (repository.licenseStatus !== "verified") throw new Error(`${item.id} no puede previsualizarse sin licencia verificada.`);
      if (repository.licenseEvidenceRef !== item.preview.upstreamRef) throw new Error(`${item.id} debe usar el mismo commit que la evidencia de licencia.`);
      const repositoryParts = new URL(repository.url).pathname.replace(/\/$/, "").split("/").filter(Boolean);
      if (repositoryParts.length !== 2) {
        throw new Error(`${item.id} usa una ruta de preview no permitida.`);
      }
      const expectedRawUrl = raw(repositoryParts.join("/"), item.preview.upstreamRef, item.preview.path);
      if (item.preview.rawUrl !== expectedRawUrl) throw new Error(`${item.id} usa un origen de preview no permitido.`);
    }
  }
}
