...
export const metadata: Metadata = {
  title: "Términos",
  description: "Condiciones de uso de Lakehouse Lab y límites de sus simulacros internos.",
  ...
  return <PublicShell active="terms">
    <main id="public-main" className="public-document-main" tabIndex={-1}>
      <article className="public-document">
        ...
        <section><h2>Constancia interna</h2><p>La constancia emitida por Lakehouse Lab registra únicamente la finalización de requisitos internos de esta ruta. No es una certificación proctorizada ni una acreditación expedida por Databricks.</p></section>
        <section><h2>Disponibilidad</h2><p>La plataforma puede cambiar, interrumpirse o retirar contenido para corregir errores y mantener la seguridad. Antes de depender de tus resultados, utiliza la función de exportación disponible en Mi cuenta.</p></section>
