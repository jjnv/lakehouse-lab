  ...
  return <PublicShell active="terms">
    <main id="public-main" className="public-document-main" tabIndex={-1}>
      <article className="public-document">
        ...
        <p className="public-document-lead">Estas condiciones se aplican a la beta pública de Lakehouse Lab. Última actualización: {CONTENT_REVIEW_DATE}.</p>
        ...
        <section><h2>Uso permitido</h2><p>Puedes utilizar la plataforma para aprendizaje personal, evaluación formativa y demostración técnica. No puedes intentar acceder a datos de otras personas, alterar el servicio, automatizar abuso, distribuir bancos de preguntas como dumps de examen ni presentar las credenciales internas como certificaciones oficiales.</p></section>
        ...
        <section><h2>Disponibilidad</h2><p>La beta puede cambiar, interrumpirse o retirar contenido para corregir errores y mantener seguridad. Antes de depender de tu expediente, utiliza la función de exportación disponible en Ajustes.</p></section>
