  ...
  return <PublicShell active="privacy">
    <main id="public-main" className="public-document-main" tabIndex={-1}>
      <article className="public-document">
        ...
        <section><h2>Responsable y alcance</h2><p>Lakehouse Lab es un proyecto personal independiente. Esta política cubre la web pública, el catálogo, los notebooks y el espacio personal de aprendizaje. Las solicitudes sobre datos se gestionan desde la sección Ajustes del propio espacio.</p></section>
        <section><h2>Datos tratados</h2><ul><li>Un identificador aleatorio y anónimo guardado en una cookie privada del navegador; no solicitamos nombre ni correo.</li><li>Progreso: lecciones, repasos, laboratorios, intentos, resultados y credenciales.</li><li>Preferencias de aprendizaje, como objetivo, dedicación semanal y entorno principal.</li><li>Datos técnicos mínimos necesarios para seguridad, diagnóstico e integridad de las operaciones.</li><li>Los borradores de recuerdo activo se guardan únicamente en el navegador.</li><li>Si generas un código de recuperación, el servidor conserva solo su huella criptográfica y nunca el código legible.</li></ul></section>
