...
export default async function CatalogoPage() {
  ...
  return <AppShell active="catalog" title="Catálogo" brand={context.brand} userDisplayName={context.userDisplayName}><CatalogWorkspace modules={moduleSummaries()} /></AppShell>;
}
