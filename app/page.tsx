...
function EditorialSection() {
  return <section id="editorial" className="editorial" aria-labelledby="editorial-title">
    ...
    <div className="changelog"><div><p className="eyebrow">Changelog</p><h3>v{SITE_VERSION} · {REVIEWED_AT}</h3><p>Preguntas contenidas y laboratorios con límites explícitos.</p></div><ul><li>Los enunciados y respuestas se ajustan al ancho disponible, incluso con términos técnicos largos y en móvil.</li><li>Cada laboratorio organiza la práctica en construir, comprobar y explicar.</li><li>La ficha de entorno y requisitos queda plegada para reducir fricción sin perder trazabilidad.</li><li>El editor se identifica como borrador local: no ejecuta Databricks ni Spark.</li><li>La finalización registra evidencia declarada; no se presenta como validación independiente del workspace.</li></ul></div>
