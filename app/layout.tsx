...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Lakehouse Lab v1.4.0 — Academia Databricks Data Engineering",
    ...
    openGraph: {
      title: "Lakehouse Lab v1.4.0 — De Associate a Professional",
    ...
    twitter: {
      ...
      title: "Lakehouse Lab v1.4.0 — Academia Databricks",
