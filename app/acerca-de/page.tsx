  ...
  return <PublicShell active="about">
    <main id="public-main" className="public-document-main" tabIndex={-1}>
      <article className="public-document">
        ...
        <section><h2>Qué demuestra</h2><p>El proyecto combina diseño de producto, desarrollo full-stack, sesiones privadas, persistencia, accesibilidad, evaluación y modelado de un currículo técnico. La experiencia se ejecuta con Next.js, TypeScript, Vercel y Turso.</p></section>
